...
public class User implements Serializable {
    ...
    @OneToMany(mappedBy = "comUserID")
    private Collection<Comment> commentCollection;
    @OneToMany(mappedBy = "postUserID")
    private Collection<UserPost> userPostCollection;
    ...
    @XmlTransient
    public Collection<UserPost> getUserPostCollection() {
        return userPostCollection;
    }

    public void setUserPostCollection(Collection<UserPost> userPostCollection) {
